...
package Commands is
   ...
   type Option_Kind is ( OptPrintSuccess,
			 OptExpandDefinitions,
			 OptInteractiveMode,
			 OptProduceProofs,
			 OptProduceUnsatCores,
			 OptProduceModels,
			 OptProduceAssignments,
			 OptRegularOutputChannel,
			 OptDiagnosticOutputChannel,
			 OptRandomSeed,
			 OptVerbosity,
			 OptAttr );
   
   type Option_Aux(O:Option_Kind) is private;
   type Option is access all Option_Aux;
   
   function String_Of_Option_Aux(O:in Option_Aux) return String;
   function String_Of_Option(O:in Option) return String;
   
   type Info_Flag_Kind is (Info_AllStatistics,
			  Info_ErrorBehavior,
			  Info_Name,
			  Info_Authors,
			  Info_Version,
   ...
   type Info_Flag_Aux(I:Info_Flag_Kind) is private;
   type Info_Flag is access all Info_Flag_Aux;
   
   function Build_Info_Flag(J:in Info_Flag_Kind;A:Attr := null) return Info_Flag;
   function String_Of_Info_Flag_Aux(I:in Info_Flag_Aux) return String;
   function String_Of_Info_Flag(I:in Info_Flag) return String;
...
private
   ...
   type Info_Flag_Aux(I:Info_Flag_Kind) is 
      record
	 case I is
